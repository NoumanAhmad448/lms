...
class CourseEx2Controller extends Controller
{
    ...
    public function chatIns()
    {
        try {
            ...
            return view('lms::xuesheng.chat-history', ['title' => $title, 'all_inss' => $all_inss]);
        } catch (\Throwable $th) {
            if(config("app.env")){
                dd($th->getMessage());
            }else{
    ...
    public function emailToIns()
    {
        try {
            ...
            return view('lms::xuesheng.send-email-to-ins', compact('title', 'c_titles'));
        } catch (\Throwable $th) {
            if(config("app.env")){
                dd($th->getMessage());
            }else{
    ...
    public function myLearning()
    {
        try {
            ...
            return view('lms::xuesheng.my-learning', compact('title', 'courses'));
        } catch (\Throwable $th) {
            if(config("app.env")){
                dd($th->getMessage());
            }else{
    ...
    public function getCerti(Request $request)
    {
        try {
            ...
            $name = auth()->user()->name;
            return view('lms::xuesheng.get_cert', compact('title', 'name'));
        } catch (Exception $e) {
