...
class BloggerFaqController extends Controller
{
    public function view()
    {
        try {
            ...
            if ($setting->isFaq) {
                ...
                $title = "faqs";
                return view('lms::bloggers.view_faq', compact('title', 'faqs', 'setting'));
            } else {
                return back();
            }
        } catch (\Throwable $th) {
    ...
    public function createFaq()
    {
        try {
            ...
            if ($setting->isFaq) {
                $title = "create_faq";
                return view('lms::bloggers.create_faq', compact('title', 'setting'));
            } else {
                return back();
            }
        } catch (\Throwable $th) {
    ...
    public function editFaq(Faq $faq)
    {
        try {
            ...
            if ($setting->isFaq) {
                $title = "e_faq";
                return view('lms::bloggers.edit_faq', compact('title', 'faq', 'setting'));
            } else {
                return back();
            }
        } catch (\Throwable $th) {
