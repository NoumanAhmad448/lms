...
class SetttingController extends Controller
{
    public function general_setting()
    {
        try {
            $title = 'stng';
            return view('lms::admin.setting.g_setting', compact('title'));
        } catch (\Throwable $th) {
            return back();
        }
    }
    ...
    public function lms_setting()
    {
        try {
            $title = 'lms';
            $s =  Setting::first();
            return view('lms::admin.setting.lms_setting', compact('title', 's'));
        } catch (\Throwable $th) {
            return back();
        }
    }
    ...
    public function paymentGateways()
    {
        try {
            ...
            return view('lms::admin.payment-gateways', compact('title', 'setting'));
        } catch (Exception $e) {
    ...
    public function blog()
    {
        try {
            ...
            return view('lms::admin.setting.bloggers_setting', compact('title', 's'));
        } catch (\Throwable $th) {
            return back();
        }
    }
