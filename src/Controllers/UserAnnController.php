...
class UserAnnController extends Controller
{
    ...
    public function viewInstructorDetail(User $user)
    {
        try {
            if (isAdmin()) {
                $title = 'view_i_detail';
                return view('lms::admin.monthly_detail', compact('title', 'user'));
            }
        } catch (\Throwable $th) {
            return back();
        }
    ...
    public function createInfo()
    {
        try {
            $title = "i_ann";
            return view('lms::admin.i_ann_user', compact('title'));
        } catch (\Throwable $th) {
            return back();
        }
    }
    ...
    public function showInfo()
    {
        try {
            ...
            return view('lms::admin.s_ann_user', compact('title', 'users'));
        } catch (\Throwable $th) {
            return back();
        }
    }
    ...
    public function showEdit($i)
    {
        try {
            ...
            return view('lms::admin.show_edit_ann_user', compact('title', 'instructor'));
        } catch (\Throwable $th) {
            return back();
        }
    }
