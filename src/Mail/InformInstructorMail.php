...
class InformInstructorMail extends Mailable
{
    ...
    {
        return $this->from(getCourseEmail(), config('app.name'))->subject("Student " . $this->u_name . " has bought the " . $this->course_name . " course from " . config('app.name'))->markdown('lms::emails.inform-instructor');
    }
}
