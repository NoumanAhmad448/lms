      ...
      success: function(result) {
          ...
          if(res['status'] == 'success'){
            ...
            if(body.find('.msg').length === 0){
              body.html(`<h4 class="text-center my-3 msg"> Congtratulation </h4><p class="text-justify"> Your course has been submitted for review to lms. Now, Please wait for the
