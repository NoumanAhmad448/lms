                                ...
                                <div class="row">
                                    ...
                                    <div class="col-1 cursor_pointer">
                                        <div class="comment_edit" message="{{ $comment->comment }}"
                                            comment_id = "{{ $comment->id }}"><i class="fa fa-pencil text-success"
                                                aria-hidden="true"></i>
                                        </div>
                                    </div>
                                    <div class="col-1 cursor_pointer text-danger">
                                        <div onClick="deleteComment({{ $comment->id }})"><i class="fa fa-trash-o"
                                                aria-hidden="true"></i>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('laoshi-commentUpdate') }}" method="POST" class="mt-5">
                    ...
                    <div class="form-group">
                        <label for="message">Type Comment</label>
                        <textarea class="form-control" name="new_msg" id="new_msg" rows="10" placeholder="start writing...."></textarea>
                    </div>
