                        ...
                        <section class="row my-3 ml-3">
                            <div class="col-2">
                                <img height="50" width="50" class="rounded-circle object-cover"
                                    src="@if ($user->profile_photo_path) {{ asset($user->profile_photo_path) }} @else
            {{ $user->profile_photo_url }} @endif"
                                    alt="{{ $user->name }}" />
                            </div>
                            <div class="col">
                                ...
                                <div onClick="deleteComment({{ $c->id }})" class="cursor_pointer text-danger">
                                    delete</i>
