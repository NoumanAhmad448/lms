...
@section('content')
                        ...
                        <div class="col-12 col-md my-5">
                            @if ($course->slug)
                                <div class="card w-100" style="height: 26rem">
                                    ...
                                    <p class="card-text text-capitalize mt-1 mb-0 d-flex font-bold"> @if ($course->price->is_free)  {{ __('lms::free') }} @else 
    ...
    @else
        <section class="d-flex justify-content-center flex-column align-items-center my-5">
            <img src="{{ asset('vendor/lms/img/record.jpg') }}" alt="record" class="img-fluid w-50" width="100"
                height="100" />
