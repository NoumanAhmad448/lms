...
<div id="{{ $modal_id }}" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative justify-center items-center p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative rounded-lg shadow dark:bg-gray-700">
            <!-- Modal header -->
            <div
                class=" bg-blue-500 text-white flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                <h3 class="text-xl font-semibold text-white-900 dark:text-white">
                    {{ __('lms::messages.opeation') }}
                </h3>
            ...
            <!-- Modal footer -->
            <div id="modal_footer"
                class="@if (empty($footer)) hidden @endif flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
