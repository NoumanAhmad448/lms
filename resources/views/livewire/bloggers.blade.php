                ...
                <tbody>
                    ...
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td> {{ $user->email ?? '' }} </td>
                            @if (isSuperAdmin())
                                <td> <a href="{{ route('edit_blogger___', compact('user')) }}"> Edit </a> </td>
                            @endif
                            @if (isSuperAdmin())
                                <td>
                                    <div class="cursor_pointer text-danger del-blogger"
                                        link="{{ route('delete_blogger___', compact('user')) }}"> Delete </div>
                                </td>
                            @endif
                        </tr>
                    @endforeach
