        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('index') }}">
                        <img src="{{ asset('vendor/lms/img/logo.jpg') }}" alt="lms" class="img-fluid"
                            width="80" />
                    </a>
                </div>
                        ...
                        <div class="d-flex">
                            ...
                            <button
                                ...
                                <img class="h-12 w-12 rounded-full object-cover"
                                    src="@if (auth() && Auth::user() && Auth::user()->profile_photo_path) {{ asset(Auth::user()->profile_photo_path) }} @else
