...
<input type="hidden" id="callBackURL" name="callBackURL" value="{{ route('get-token-pay', compact('slug')) }}">
...
<script>
    ...
    $("#submitPaymentMethod").click(function() {
        return loadIframe('easypay-iframe', 'https://easypay.easypaisa.com.pk/tpg/');
    });
