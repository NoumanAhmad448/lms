            ...
            <div class="col">
                <div class="d-flex flex-row justify-content-between my-4">
                    <section class="d-flex">
                        <a class="mr-1" href="http://127.0.0.1:8000/dashboard"> lms </a>
                        <div> Step 4 of 4 </div>
                    </section>
                ...
                <div class="progress" style="height: 1px;">
                    <div class="progress-bar w-100" role="progressbar" aria-valuenow="50" aria-valuemin="0"
                    ...
                    <form id="nextform"
                        ...
                        <section class="d-flex flex-column">
                            ...
                            <div class="form-check border border-secondary pl-5 py-3 option">
                                <input class="form-check-input" type="radio" name="time_selection" id="time_selection1"
                                    value="option1">
                            ...
                            <div class="form-check border border-secondary pl-5 py-3 option mt-2">
                                <input class="form-check-input" type="radio" name="time_selection" id="time_selection2"
                                    value="option2">
                            ...
                            <div class="form-check border border-secondary pl-5 py-3 option mt-2">
                                ...
                                <input class="form-check-input" type="radio" name="time_selection" id="time_selection3"
                                    value="option3">
                            ...
                            <div class="form-check border border-secondary pl-5 py-3 option mt-2">
                                <input class="form-check-input" type="radio" name="time_selection" id="time_selection4"
                                    value="option4">
        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <a href="{{ route('courses_instructions', ['id' => $id - 1, 'course_id' => $course_id]) }}"
...
@section('course_footer')
    <script src="{{ asset('vendor/lms/js/course_time_selection.js') }}"></script>
@endsection
