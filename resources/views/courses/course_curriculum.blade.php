@extends('lms::courses.dashboard_main')
@section('page-css')
...
@php
    ...
    use Eren\Lms\Models\Description;
...
@section('content')
                                ...
                                <div class="row">
                                    ...
                                    @if ($sec_no != '1')
                                        <section class="del_sec_container col-md-2 ">
                                            ...
                                            <div
                                                class="del_sec btn text-danger d-flex align-items-center float-right icon-sm p-0">
                                                    ...
                                                    <div class="col-md-6 d-md-flex align-items-md-center mt-3 mt-md-0">
                                                        ...
                                                        <div class="btn website-outline @if ($assign->ass_f_name) add_assign_show @else add_assign @endif  ml-2"
                                                            ...
                                                            @if ($assign->ass_f_name)
                                                                {!! __('lms::<i class="las la-caret-down"></i>') !!}
                                                            @else
                                                                {!! __('lms::<i class="las la-plus"></i>') !!}
                                                            @endif Assignment
                                                        </div>
    ...
    <div class="modal fade" id="bulk" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body p-3">
                    ...
                    <p> You can upload multiple video files at the same time but the total size of all videos must be less
                        than
                        4GB. After uploading, you may choose your video from the video uploading section of your lecture.
                    </p>
                    <hr />
                    <form url="{{ route('bulk_loader', ['course' => $course_id]) }}" enctype="multipart/form-data"
                        id="bulk-form">
                        ...
                        <div class="progress d-none my-3">
                            <div class="progress-bar progress-bar-striped bg-info" role="progressbar" style="width: 25%;"
                                id="show_progress" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">25%
                            </div>
                        </div>
...
@section('page-js')
    <script>
        $(function() {
            ...
            $('.sec-container').on('click', '.cancel', function() {
                ...
                let main_parent = $(this).parents('.col-md-12').removeClass('col-md-12').addClass(
                    'col-md-7');
            ...
            $('.sec-container').on('click', '.video_res_can', function() {
                ...
                if (parent.length > 0) {
                    ...
                    $(this).removeClass('video_res_can btn-danger').addClass('video_res').text(
                        'Upload Video');
            ...
            $('.sec-container').on('submit', '.c_lec_small_form', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $('.success').removeClass('d-none').addClass('d-block').text(data[
                            'status']);
                        ...
                        $('.lec_small_container').parents('.col-md-12').removeClass('col-md-12')
                            .addClass('col-md-7');
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <form class="upload_video_form">
                                    ...
                                    <div class="form-check my-3">
                                        <input class="form-check-input" type="checkbox" id="set_download" name="set_download">
                                        <label class="form-check-label" for="set_download">
                                            set video download
                                        </label>
                                    </div>
                                    <div class="custom-file mt-3">
                                        <input type="file" name="upload_video" class="custom-file-input upload_video" id="custom_file"
                        ...
                        if (video_url) {
                            $.ajax({
                                ...
                                success: function(data) {
                                    ...
                                    video_btn.removeClass('video_res_can').addClass(
                                        'uploaded_res_video_close').html(
                                        '<i class="las la-times"></i>Uploaded Video');
                                    res.prev('.lecture_container').find('.lec_more_close')
                                        .removeClass('lec_more_close').addClass(
                                            'added_res_cancel');
            ...
            $('.sec-container').on('click', '.v_c_vid', function() {
                ...
                $(this).html('<i class="las las la-times"></i> Video').removeClass(
                    'website-outline v_c_vid').
            ...
            $('.sec-container').on('click', '.lec_content_show', function() {
                ...
                $(this).html('<i class="las las la-times"></i> Video').removeClass(
                    'website-outline lec_content_show').
            ...
            $('.sec-container').on('click', '.v_c_p_can', function() {
                ...
                $(this).html('<i class="las la-plus"></i> Video').addClass(
                    'website-outline lec_content_show').
                        ...
                        if (form_url) {
                            $.ajax({
                                ...
                                if (video_url) {
                                    ...
                                    if (lec_con) {
                                        let lecture_container = lec_con.prevAll(
                                            '.lecture_container').first();
                                        if (lecture_container) {
                                            let v_c_can = lecture_container.find('.v_c_can');
                                            if (v_c_can) {
                                                v_c_can.html('<i class="las la-plus"></i> Video')
                                                    .removeClass('btn-danger v_c_can').addClass(
                                                        'lec_content website-outline').attr(
                                                        'video_url', video_url);
                                            } else {
                                                ...
                                                if (v_c_p_can) {
                                                    v_c_p_can.html(
                                                        ...
                                                        .removeClass('btn-danger v_c_p_can')
                                                        .addClass(
                                                            'lec_content_show website-outline')
                                                        .attr('video_url', video_url);
                                                }
                                            }
            ...
            $('.sec-container').on('click', '.lec_desc', function() {
                ...
                if (desc_url) {
                    ...
                    `);
                        ...
                        $(this).removeClass('lec_desc  website-outline').addClass(
                            'btn-danger lec_desc_p_cancel').
            ...
            $('.sec-container').on('click', '.lec_desc_cancel', function() {
                $(this).parents('.lecture_container').first().nextAll('.lec_desc_con').first().addClass(
                    'd-none');
            ...
            $('.sec-container').on('click', '.lec_desc_p_cancel', function() {
                $(this).parents('.lecture_container').first().nextAll('.lec_desc_con').first().addClass(
                    'd-none');
                $(this).removeClass('btn-danger lec_desc_p_cancel').addClass(
                    'lec_desc_p_show  website-outline').
            ...
            $('.sec-container').on('click', '.lec_desc_p_show', function() {
                let con = $(this).parents('.lecture_container').first();
                con.nextAll('.lec_desc_con').first().removeClass('d-none');
                $(this).removeClass('website-outline lec_desc_p_show').addClass(
                    'lec_desc_p_cancel btn-danger').
                html('<i class="las la-times"></i> Description');
            ...
            $('.sec-container').on('click', '.lec_desc_update_cancel', function() {
                $(this).parents('.lecture_container').first().nextAll('.lec_desc_con').addClass('d-none')
                    .removeClass('d-block');
                $(this).removeClass('btn-danger lec_desc_update_cancel').addClass(
                    'lec_desc_update_php website-outline').
                html('<i class="las la-caret-down"></i> Description');
                ...
                if (form.length > 0) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            let desc_btn_ = lec_con.prev('.lecture_container').find(
                                '.lec_desc_cancel');
                            if (desc_btn_.length > 0) {
                                desc_btn_.removeClass('lec_desc_cancel').addClass(
                                    'lec_desc_update_cancel').html(
                                    '<i class="las la-caret-down"></i> Description');
                            }
                            if (status) {
                                show_message(status);
            ...
            $('.sec-container').on('click', '.lec_desc_update', function() {
                ...
                $(this).parents('.sec-container').first().nextAll('.lec_desc_con').removeClass('d-none')
                    .addClass('d-block');
                $(this).removeClass('lec_desc_update website-outline').addClass(
                    'lec_desc_update_cancel btn-danger').html(
                    '<i class="las las la-times"></i>Description');
            });
            ...
            $('.sec-container').on('click', '.lec_desc_update_php', function() {
                ...
                $(this).removeClass('lec_desc_update_php website-outline').addClass(
                    'lec_desc_update_cancel btn-danger').html(
                    '<i class="las las la-times"></i>Description');
            ...
            $('.sec-container').on('click', '.lec_more', function() {
                ...
                if (parent && vid_url) {
                    ...
                    `);
                    $(this).removeClass('lec_more website-outline').addClass('lec_more_close btn-danger')
                        .html('<i class="las la-times"></i>Resources');
            ...
            $('.sec-container').on('click', '.lec_more_close', function() {
                ...
                if (parent.length > 0) {
                    ...
                    $(this).removeClass('lec_more_close btn-danger').addClass('lec_more website-outline')
                        .html('<i class="las la-plus"></i>Resources');
            ...
            $('.sec-container').on('click', '.video_res', function() {
                ...
                if (video_section.length < 1 && video_url) {
                    $(this).removeClass('video_res website-outline').addClass(
                        'video_res_can btn btn-danger').
            ...
            $('.sec-container').on('click', '.uploaded_res_video_close', function() {
                ...
                if (parent.length > 0) {
                    ...
                    $(this).removeClass('uploaded_res_video_close btn-danger').addClass(
                        'show_uploaded_vid website-outline').html(
                        '<i class="las la-caret-down"></i>Uploaded Video');
                }
            });
            ...
            $('.sec-container').on('click', '.show_uploaded_vid', function() {
                ...
                if (parent.length > 0) {
                    ...
                    $(this).removeClass('show_uploaded_vid website-outline').addClass(
                        'uploaded_res_video_close btn-danger').html(
                        '<i class="las la-times"></i>Uploaded Video');
                    ...
                    if (form.length) {
                        ...
                        if (form_url) {
                            $.ajax({
                                ...
                                if (video_url) {
                                    form.parents('.uploaded_video').prev('.resources').first().find(
                                        '.uploaded_res_video_close').
                                    html('Upload Video').removeClass(
                                        'btn-danger uploaded_res_video_close').addClass(
                                        'video_res website-outline').attr('video_url',
                                        video_url);
            ...
            $('.sec-container').on('click', '.added_res', function() {
                ...
                $(this).removeClass('added_res website-outline').addClass('added_res_cancel btn-danger')
                    .html('<i class="las la-times"></i>Resource');
            ...
            $('.sec-container').on('click', '.added_res_cancel', function() {
                ...
                if (parent) {
                    ...
                    $(this).removeClass('added_res_cancel btn-danger').addClass('added_res website-outline')
                        .html('<i class="las la-caret-down"></i>Resource');
            ...
            $('.sec-container').on('click', '.article_res', function() {
                let res_con = $(this).parents('.resources').first();
                let resource = res_con.prevAll('.lecture_container').first().find(
                    '.lec_more_close , .added_res_cancel');
            ...
            $('.sec-container').on('click', '.article_res_can', function() {
                ...
                if (res) {
                    res.addClass('d-none');
                    $(this).removeClass('article_res_can btn-danger').addClass(
                        'article_res_show website-outline').html(
                        '<i class="las la-caret-down"></i>Article');
                }
            ...
            $('.sec-container').on('click', '.article_res_show', function() {
                ...
                if (res) {
                    ...
                    $(this).removeClass('article_res_show website-outline').addClass(
                        'article_res_can btn-danger').html('<i class="las la-times"></i>Article');
                    let video_res_can = res_con.find('.video_res_can');
                    if (video_res_can) {
                        video_res_can.click();
                    }
            ...
            $('.sec-container').on('click', '.external_res_can', function() {
                ...
                if (res) {
                    res.addClass('d-none');
                    $(this).removeClass('external_res_can btn-danger').addClass(
                        'external_res_show website-outline').html(
                        '<i class="las la-caret-down"></i>External Resource');
                }
            ...
            $('.sec-container').on('click', '.external_res_show', function() {
                ...
                if (res) {
                    res.removeClass('d-none');
                    $(this).removeClass('external_res_show website-outline').addClass(
                        'external_res_can btn-danger').html(
                        '<i class="las la-times"></i>External Resource');
                    let video_res_can = res_con.find('.video_res_can');
                    if (video_res_can) {
                        video_res_can.click();
                    }
                        ...
                        if (file_url) {
                            $.ajax({
                                ...
                                success: function(data) {
                                    current_file.attr('disabled', false);
                                    let path = data['path'];
                                    let upload_vid = current_file.parents('.other_files_con')
                                        .first();
                                    let media = data['media'];
                                    let other_files_con = c_f_form.parents('.other_files_con')
                                        .first();
                                    c_f_form.remove();
                                    progress_bar.parent().remove();
            ...
            $('.sec-container').on('click', '.other_res_can', function() {
                ...
                if (res) {
                    res.addClass('d-none');
                    $(this).removeClass('other_res_can btn-danger').addClass(
                        'other_res_show website-outline').html(
                        '<i class="las la-caret-down"></i>Other Files');
                }
            ...
            $('.sec-container').on('click', '.other_res_show', function() {
                ...
                if (res) {
                    res.removeClass('d-none');
                    $(this).removeClass('other_res_show website-outline').addClass(
                        'other_res_can btn-danger').html('<i class="las la-times"></i>Other Files');
                    let video_res_can = res_con.find('.video_res_can');
                    if (video_res_can) {
                        video_res_can.click();
                    }
            ...
            $('.sec-container').on('submit', '.ass_form', function(event) {
                ...
                let lec_no = $(this).parents('.lecture_layer').first().prevAll('.lecture_container').first()
                    .find('.lec_no').text().trim();
            ...
            $('.sec-container').on('click', '.add_desc', function() {
                ...
                if (desc_url) {
                    ...
                    `);
                        ...
                        $(this).removeClass('add_desc  website-outline').addClass(
                            'btn-danger add_desc_cancel').
                        html('<i class="las la-times"></i> Description');
                    }
                }
            ...
            $('.sec-container').on('click', '.add_ass_desc', function() {
                ...
                let form = desc_btn.parent('form');
                let lec_desc = form.serialize();
                let desc__btn = $(this).parents('.ass_desc_con').first().prevAll('.assign_con').first()
                    .find('.add_desc_cancel');
                if (form.length > 0) {
                    $.ajax({
                        url: form.attr('desc_form_url'),
                        type: 'POST',
                        ...
                        success: function(data) {
                            ...
                            if (desc__btn.length > 0) {
                                desc__btn.removeClass('add_desc_cancel').addClass(
                                    'add_desc_update');
                            }
            ...
            $('.sec-container').on('click', '.add_desc_update', function() {
                ...
                $(this).removeClass('btn-danger add_desc_update').addClass(
                    'show_desc_update website-outline').
                html('<i class="las la-caret-down"></i> Description')
            });
            ...
            $('.sec-container').on('click', '.show_desc_update', function() {
                ...
                $(this).removeClass('show_desc_update website-outline').addClass(
                    'add_desc_update btn-danger').html('<i class="las las la-times"></i>Description');
            ...
            $('.sec-container').on('click', '.add_assign_can', function() {
                ...
                if (res) {
                    res.addClass('d-none');
                    $(this).removeClass('add_assign_can btn-danger').addClass(
                        'add_assign_show website-outline').html(
                        '<i class="las la-caret-down"></i>Assignment');
                }
            ...
            $('.sec-container').on('click', '.add_assign_show', function() {
                ...
                if (res) {
                    res.removeClass('d-none');
                    $(this).removeClass('add_assign_show website-outline').addClass(
                        'add_assign_can btn-danger').html('<i class="las la-times"></i>Assignment');
                }
                        ...
                        if (file_url) {
                            $.ajax({
                                ...
                                success: function(data) {
                                    ...
                                    let other_files_con = c_f_form.parents('.ass_container')
                                        .first();
                                    c_f_form.remove();
                                    progress_bar.parent().remove();
                                    other_files_con.append(`
            ...
            $('.sec-container').on('submit', '.delete_ass_file', function(e) {
                ...
                if (confirm('Do you want to delete the file?')) {
                    ...
                    if (del_url) {
                        ...
                        ass_con.prevAll('.assign_con').first().find('.add_assign_can').removeClass(
                            'add_assign_can btn-danger').addClass('add_assign website-outline').html(
                            '<i class="las la-plus"></i>Assignment');
                        ass_con.remove();
            ...
            $('.sec-container').on('click', '.add_sol_can', function() {
                ...
                if (res) {
                    res.addClass('d-none');
                    $(this).removeClass('add_sol_can btn-danger').addClass('add_sol_show website-outline')
                        .html('<i class="las la-caret-down"></i>Solution');
                }
            ...
            $('.sec-container').on('click', '.add_sol_show', function() {
                ...
                if (res) {
                    res.removeClass('d-none');
                    $(this).removeClass('add_sol_show website-outline').addClass('add_sol_can btn-danger')
                        .html('<i class="las la-times"></i>Solution');
                }
                        ...
                        if (file_url) {
                            $.ajax({
                                ...
                                success: function(data) {
                                    current_file.attr('disabled', false);
                                    let media = data['assign'];
                                    let other_files_con = c_f_form.parents('.sol_container')
                                        .first();
                                    c_f_form.remove();
                                    progress_bar.parent().remove();
                                    other_files_con.append(`
            ...
            $('.sec-container').on('submit', '.del_sol_f', function(e) {
                ...
                if (confirm('Do you want to delete the file?')) {
                    ...
                    if (del_url) {
                        ...
                        ass_con.prevAll('.assign_con').first().find('.add_sol_can').removeClass(
                            'add_sol_can btn-danger').addClass('add_sol website-outline').html(
                            '<i class="las la-plus"></i>Solution');
                        ass_con.remove();
            ...
            $('.sec-container').on('click', '.add_quiz_desc', function() {
                ...
                let form = desc_btn.parent('form');
                let lec_desc = form.serialize();
                let desc__btn = $(this).parents('.quiz_desc_con').first().prevAll('.quiz_con').first().find(
                    '.quiz_c_op');
                if (form.length > 0) {
                    $.ajax({
                        url: form.attr('desc_form_url'),
            ...
            $('.sec-container').on('click', '.quiz_q', function() {
                ...
                if (quiz_q_con !== true) {
                    ...
                    quiz_btn.removeClass('website-outline quiz_q').addClass('btn-danger quiz_q_cancel')
                        .html('<i class="las la-times"></i>Quiz');
                }
            ...
            $('.sec-container').on('click', '.quiz_q_cancel', function() {
                ...
                quiz_btn.addClass('website-outline quiz_q_show').removeClass('btn-danger quiz_q_cancel')
                    .html('<i class="las la-caret-down"></i>Quiz');
            ...
            $('.sec-container').on('click', '.quiz_q_show', function() {
                ...
                quiz_btn.removeClass('website-outline quiz_q_show').addClass('btn-danger quiz_q_cancel')
                    .html('<i class="las la-times"></i>Quiz');
                ...
                if (url) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            let q_b_con = cu_el.parents('.quiz-q-list').first().prevAll(
                                '.q_b_con').first();
            ...
            $('#upload_bulk_videos').change(function() {
                ...
                for (var index = 0; index < files.length; index++) {
                    ...
                    if (file) {
                        ...
                        if (file_type) {
                            if (file_type !== "video/mp4" && file_type !== "video/webm" && file_type !==
                                "video/ogg") {
                                up_err = true;
                                break
                            } else {
                        ...
                        xhr: function() {
                            ...
                            xhr.upload.addEventListener("progress", function(evt) {
                                if (evt.lengthComputable) {
                                    ...
                                    progress_bar.css('width', c_progress + '%');
                                    progress_bar.html('<b> Uploading  ' + c_progress +
                                        '% </b>');
                                }
                            }, false);
                            return xhr;
    ...
    <script src="{{ asset('vendor/lms/js/course/course_curriculum.js') }}"></script>
@endsection
