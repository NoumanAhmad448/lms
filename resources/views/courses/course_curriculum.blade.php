    ...
    <section class="container p-2 sec-container">
        ...
        <div class="bg-light font-weight-bold p-3 mt-3 mt-md-5 section border">
            <section>
                ...
                <div class="mt-3 container lecture_container bg-white p-3 border">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 d-md-flex align-items-md-center mt-3 mt-md-0">
                            ...
                            @endif
                            @if($should_show_res)
                            <div class="added_res btn website-outline ml-md-2 mt-2 mt-md-0 " ex_res_url="{{route('ex_res',['lec_id' => $lec_id])}}" article_url="{{route('article',['lec_id' => $lec_id])}}" other_files_url="{{route('other_files',['lec_id' => $lec_id])}}">
                                <i class="las la-caret-down"></i> Resource
                            </div>
                            @else
                            <div class="lec_more btn website-outline ml-md-2 mt-2 mt-md-0 " res_vid="{{route('upload_vid_res',['lec_id' => $lec_id])}}" article_url="{{route('article',['lec_id' => $lec_id])}}" ex_res_url="{{route('ex_res',['lec_id' => $lec_id])}}" other_files_url="{{route('other_files',['lec_id' => $lec_id])}}">
                ...
                <section class="lecture_vid row p-3 d-none">
                    <div class="col-md-12">
                        <div class="form-check my-3">
                            <input class="form-check-input is_free" type="checkbox" media_id="{{$media->id}}" id="is_free_{{$media->id}}" @if ($media->is_free){{"checked"}} @endif
        ...
        <div class="bg-light font-weight-bold p-3 section">
            <section>
                ...
                <span class="mt-3 ml-2 website-color add_material" data-toggle="tooltip" data-placement="right" title="Add Lecture,Assignment,Quiz">
                    <i class="las la-plus-circle icon-sm"></i>
                </span>
        ...
        <span class="mt-2 ml-2 website-color" id="add_sec" data-toggle="tooltip" data-placement="right" title="Add Section">
            <i class="las la-plus-circle icon-sm"></i>
        </span>
...
<div class="modal fade" id="bulk" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-body p-3">
                ...
                <form url="{{route('bulk_loader',['course' => $course_id])}}" enctype="multipart/form-data" id="bulk-form">
                    ...
                    <div class="progress d-none my-3">
                        <div class="progress-bar progress-bar-striped bg-info" role="progressbar" style="width: 25%;" id="show_progress" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">25%
                        </div>
                    </div>
...
<script src="{{asset('vendor/lms/js/course/course_curriculum.js')}}">
