                ...
                <div class="col-4">
                    <form action="{{ route('post_setting', compact('course')) }}" method="post">
                        ...
                        <button class="btn btn-lg btn-outline-info" type="submit"
                            @if ($course->status === 'draft' || $course->status === 'unpublished') {{ __('lms::disabled') }} @endif>
                            Unpublish Course
                        </button>
                    </form>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p> You are about to delete this course. If we find any user enrolled in your course, your course will
                        not be able to
                        delete on our website but will not be shown to you. However, new user will not be able to see it in
                        the search result.
                    </p>
                </div>
