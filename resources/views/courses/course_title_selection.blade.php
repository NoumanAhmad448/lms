                ...
                <div class="jumbotron text-center">
                    ...
                    <form id="nextbtn"
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input maxlength="60" type="text" class="form-control" placeholder="e.g. wordpress training"
                                required="" name="course_title" value="{{ $course_title }}" id="title_box">
...
@section('course_footer')
    <script src="{{ asset('vendor/lms/js/course_title.js') }}"></script>
@endsection
