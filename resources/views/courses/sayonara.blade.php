        ...
        <section class="sayonara">
            ...
            <form url="{{ route('zaijianPost', compact('course')) }}" class="final_form">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="wel_msg" name="wel_msg" rows="7"
                        placeholder="Welcome Message (1000 words are allowed)">
@if ($sayonara)
{{ $sayonara->welcome_msg ?? '' }}
@endif
</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="congo_msg" name="congo_msg" rows="7"
                        placeholder="Congtratulation Message (1000 words are allowed)">
@if ($sayonara)
{{ $sayonara->congo_msg ?? '' }}
@endif
</textarea>
        ...
        <section class="my-2">
            ...
            @else
                ...
                <div class="mt-2"> You can definately change your URL if you wish but you can only change it once.
                    Please do it, if you think your url is not suitable for your students. <p class="text-danger"> Please
                        make sure, you can
                ...
                <form action="{{ route('course-change-url', ['course' => $course->id]) }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text">https://lms.com/course/</span>
                        </div>
                        <input type="text" class="form-control @error('slug') is-invalid @enderror" placeholder="url"
                            ...
                            value="@if (old('slug')) {{ old('slug') }} @else {{ $course->slug }} @endif">
                    </div>
                    @error('slug')
...
@section('page-js')
    <script src="{{ asset('vendor/lms/js/message.js') }}"></script>
@endsection
