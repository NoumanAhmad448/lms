...
@section('content')
    ...
    <div class="d-flex justify-content-end">
        <a href="{{ route('blogger_c_faq') }}" class="btn btn-lg btn-info"><i class="fa fa-pencil-square-o"
                aria-hidden="true"></i>
            Create FAQ
        </a>
    </div>
                ...
                <tbody>
                    @foreach ($faqs as $faq)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('blogger_cs_faq', compact('faq')) }}" method="post">
                                    @csrf
                            ...
                            <td>
                                <div class="text-success">
                                    <a href="{{ route('blogger_edit_faq', compact('faq')) }}">
                                        <i class="fa fa-pencil" aria-hidden="true"></i>
                                    </a>
                                </div>
                            </td>
                            <td>
                                <form action="{{ route('blogger_faq_delete', compact('faq')) }}" method="POST">
                                    @csrf
                                    @method('delete')
                                    <div class="text-danger delete_faq cursor_pointer"> <i class="fa fa-trash"
...
@else
    <div class="jumbotron text-center bg-white mt-5">
        <img src="{{ asset('vendor/lms/img/not_found.png') }}" alt="no faq found" width="100" height="100"
