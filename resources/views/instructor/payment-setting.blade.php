...
@section('content')
    <div class="container">
        ...
        <ul class="nav nav-pills mb-3" id="payment-options" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link" id="payoneer" data-toggle="pill" href="#payoneer-form" role="tab"
                    aria-selected="false">
                    ...
                    <section>
                        ...
                        <form action="{{ route('i_bank_payment') }}" method="post">
                            ...
                            <div class="row my-5">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control hide @error('b_name') is-invalid @enderror"
                                        id="b_name"
                                        value="@if (isset($setting)) {{ $setting->b_name ?? '' }} @endif"
                                        name="b_name" placeholder="Bank Name">
                                    @error('b_name')
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6">
                                    <input type="text"
                                        class="form-control hide @error('b_swift_code') is-invalid @enderror"
                                        id="b_swift_code"
                                        value="@if (isset($setting)) {{ $setting->b_swift_code ?? '' }} @endif"
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6">
                                    <input type="text"
                                        class="form-control hide @error('b_account_name') is-invalid @enderror"
                                        id="b_account_name"
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6">
                                    <input type="text"
                                        class="form-control hide @error('b_account_no') is-invalid @enderror"
                                        id="b_account_no"
                                        value="@if (isset($setting)) {{ $setting->b_account_no ?? '' }} @endif"
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6">
                                    <input type="text"
                                        class="form-control hide @error('b_branch_name') is-invalid @enderror"
                                        id="b_branch_name"
                                        value="@if (isset($setting)) {{ $setting->b_branch_name ?? '' }} @endif"
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6">
                                    <input type="text"
                                        class="form-control hide @error('b_branch_addr') is-invalid @enderror"
                                        id="b_branch_addr"
                                        value="@if (isset($setting)) {{ $setting->b_branch_addr ?? '' }} @endif"
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control hide @error('b_iban') is-invalid @enderror"
                                        id="b_iban"
                                        value="@if (isset($setting)) {{ $setting->b_iban ?? '' }} @endif"
                                        name="b_iban" placeholder="Branch Name">
                                    @error('b_iban')
                                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <section>
                        ...
                        <form action="{{ route('i_paypal_payment_withdraw') }}" method="post">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6">
                                    <input type="text"
                                        class="form-control hide @error('paypal_account') is-invalid @enderror"
                ...
                <section>
                    ...
                    <form action="{{ route('i_payoneer_payment_withdraw') }}" method="post">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-6">
                                <input type="text"
                                    class="form-control hide @error('payoneer_account') is-invalid @enderror"
                    ...
                    <section>
                        ...
                        <form action="{{ route('i_jazzcash_payment_withdraw') }}" method="post">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6">
                                    <input type="text"
                                        class="form-control hide @error('j_account') is-invalid @enderror" id="j_account"
                                        name="j_account"
                    ...
                    <section>
                        ...
                        <form action="{{ route('i_easypaisa_payment_withdraw') }}" method="post">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6">
                                    <input type="text"
                                        class="form-control hide @error('e_account') is-invalid @enderror" id="e_account"
                                        name="e_account"
