...
<section class="col-md-8 offset-md-2"
    style="display: flex;justify-content: center;align-items: center;margin-top: 1rem; margin-bottom: 1rem; ">

    <div
        style="padding:2px; text-align:center; background-color: #FFFFFF;border: 0.2rem solid #000066;background-image: url('{{ asset('vendor/lms/img/bg-cert.jpg') }}')">

        <div style="width:750px; padding:20px; >
                <div class="float-right"> </div>
        <br />
        <div style="font-size:50px; font-weight:bold;font-family: 'Norican', cursive; color: #000">Certificate of
            Completion</div>
