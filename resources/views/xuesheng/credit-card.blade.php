...
@section('page-css')
    <link rel="stylesheet" href="{{ asset('vendor/lms/css/credit_card_form.css') }}">
...
@section('content')
    <div class="container my-5">
        ...
        <div class="form-group">
            ...
            <input id="card-holder-name" type="text" name="card_holder_name" placeholder="Name On Your Card"
                class="form-control">
        </div>
...
@section('script')
    ...
    {{-- <script src="{{asset('vendor/lms/js/credit_card_form.js')}}"></script> --}}
    <script src="https://js.stripe.com/v3/"></script>
