                    ...
                    <section class="d-flex">
                        ...
                        @if (isset($of_p_methods) && $of_p_methods && $of_p_methods->count())
                            <form action="{{ route('offline-payment') }}" method="POST">
                                ...
                                <button type="submit" class="btn btn-lg btn-website ml-4"> Offline Payment </button>
                            </form>
                        @endif
                    </section>
                </div>
            ...
            <div class="col-12">
                @if (isset($of_p_methods) && $of_p_methods && $of_p_methods->count())
                    ...
                    <div class="text-danger mt-3">
                        You can choose any available method. First you need to pay by choosing any available method. After
                        that,
                        ...
                        and will enroll you in this course. You can contact us from any method that are available on this
                        page
                    </div>
                    <div class="mt-5">
                ...
                @if ($of_p_methods->o_is_enable)
                    <div class="card">
                        <div class="card-header" id="headingFour">
                            <h2 class="mb-0">
                                <button class="btn btn-link btn-block text-left collapsed" aria-controls="collapseFour"
