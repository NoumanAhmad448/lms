...
@endsection
    ...
    <x-jet-authentication-card>
        ...
        <a href="{{ route('google-login') }}" style="" class="btn btn-info btn-lg d-block my-1"> <i class="fa fa-google" aria-hidden="true"></i>
            Sign In With Google 
        </a>
        <a href="{{ route('fb-login') }}" style="" class="btn btn-info btn-lg  my-1 d-block"> <i class="fa fa-facebook" aria-hidden="true"></i>

            Sign In With Facebook 
        </a>
        <a href="{{ route('li-login') }}" style="" class="btn btn-info btn-lg  my-1 d-block"> <i class="fa fa-linkedin" aria-hidden="true"></i>            
    ...
    @section('script')
        <script>
         ...
         <script>
            var seo = "Login to lms an E learning platform to shape the future of your students by giving the online training of their desire course.";
            $("#seo_desc").attr('content',
            seo);
            $("#seo_fb").attr('content',seo
            );
            $('#seo_title').text('Login | lms');
        </script>
    @endsection
</x-guest-layout>
