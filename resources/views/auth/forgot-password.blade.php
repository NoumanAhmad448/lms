<x-guest-layout>
        ...
        <x-jet-authentication-card>
            ...
            <form method="POST" action="{{ route('password.email') }}">
                ...
                <div class="block">
                    ...
                    <x-jet-input id="email" class="block mt-1 w-full" placeholder="Email" type="email" name="email"
    ...
    @section('script')
        <script>
            var seo =
                "If you forget your password then reset your password to login again on lms, an online educational platform.";
            $("#seo_desc").attr('content',
                seo);
            $("#seo_fb").attr('content', seo);
            $('#seo_title').text('Forgot Password | lms');
        </script>
    @endsection
</x-guest-layout>
