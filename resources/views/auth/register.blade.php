        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-check mt-3">
                ...
                <label class="form-check-label" for="terms">
                  I accept these <a href="https://lms.com/page/terms-and-conditions" class="text-primary">terms</a> and <a class="text-primary" href="https://lms.com/page/privacy-policy">conditions</a>
                </label>
              </div>
