      ...
      <div class="row pt-2 pt-md-5">
        <div class="col-md-3 mt-3 mt-md-0">
          ...
          <div class="text-justify">
            lms is a LMS platform that connect Teachers with Students globally. Teachers create high quality course
        ...
        <div class="col-md-3 mt-3 mt-md-0">
          <ul class="list-unstyled">
            <li class="mt-2"><a class="text-white" href="https://lms.com/page/about-us"> About Us </a></li>
            <li class="mt-2"><a class="text-white" href="https://lms.com/page/privacy-policy"> Privacy Policy </a>
            </li>
        ...
        <div class="col-md-3 mt-3 mt-md-0">
          ...
          <div class="d-inline text-white">
            ...
            <a class="text-white mr-2" href="https://www.linkedin.com/company/lms"> <i class="fa fa-linkedin"
                aria-hidden="true"></i>
            </a>
            <a class="text-white" href="https://twitter.com/lms1"> <i class="fa fa-twitter" aria-hidden="true"></i>
            </a>
          </div>
        </div>
