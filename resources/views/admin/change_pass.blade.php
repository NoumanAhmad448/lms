        ...
        <div class="form-group">
            ...
            <div class="input-group mb-3">
                ...
                <div class="input-group-append">
                    <span class="input-group-text cursor_pointer" id="show_p"><i class="fa fa-eye"
                            aria-hidden="true"></i>
                    </span>
                </div>
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            <input type="password" class="form-control @error('c_pass') is_invalid @enderror" id="c_pass"
                                name="c_pass" placeholder="New Password" value="{{ old('c_pass') }}">
                            <span class="input-group-text cursor_pointer" id="show_c_p"><i class="fa fa-eye"
                                    aria-hidden="true"></i>
                            </span>
                        </div>
                        @error('c_pass')
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            <input type="password" class="form-control" id="c_pass_2" name="c_pass_2"
                                placeholder="Confirm Password" value="{{ old('c_pass_2') }}" />
                            <span class="input-group-text cursor_pointer" id="show_c_p2"><i class="fa fa-eye"
                                    aria-hidden="true"></i>
                            </span>
                        </div>
                        @error('c_pass_2')
