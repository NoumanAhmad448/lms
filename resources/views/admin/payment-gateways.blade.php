...
@section('content')
    ...
    <ul class="nav nav-pills mb-3" id="payment-options" role="tablist">
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="stripe" data-toggle="pill" href="#stripe-form" role="tab" aria-selected="true"> <i
                    class="fa fa-cc-stripe" aria-hidden="true"></i> Stripe</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="paypal" data-toggle="pill" href="#paypal-form" role="tab" aria-selected="false">
            ...
            <section>
                ...
                <form action="{{ route('a_strip_payment') }}" method="post">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control hide @error('s_s_key') is-invalid @enderror"
                                id="s_s_key"
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control hide @error('s_p_key') is-invalid @enderror"
                                id="s_p_key" name="s_p_key"
            ...
            <section>
                ...
                <form action="{{ route('a_paypal_payment') }}" method="post">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control hide @error('p_s_key') is-invalid @enderror"
                                id="p_s_key"
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control hide @error('p_p_key') is-invalid @enderror"
                                id="p_p_key" name="p_p_key"
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control hide @error('paypal_email') is-invalid @enderror"
                                id="paypal_email" name="paypal_email"
            ...
            <section>
                ...
                <form action="{{ route('a_jazzcash_payment') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="jazzcash_form"
                                    name="jazzcash_form"
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control hide @error('j_s_key') is-invalid @enderror"
                                id="j_s_key"
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control hide @error('j_p_key') is-invalid @enderror"
                                id="j_p_key" name="j_p_key"
            ...
            <section>
                ...
                <form action="{{ route('a_easypaisa_payment') }}" method="post">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control hide @error('e_s_key') is-invalid @enderror"
                                id="e_s_key"
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control hide @error('e_p_key') is-invalid @enderror"
                                id="e_p_key" name="e_p_key"
