...
@section('content')
    ...
    <div class="d-flex justify-content-end">
        <a href="{{route('admin_v_page')}}" class="btn btn-lg btn-info"> View Page </a>
    </div>

    <form method="POST" action="{{route('admin_s_page')}}" enctype="multipart/form-data"    >
        @csrf
        ...
        <button type="submit" class="btn btn-lg btn-info"> 
            <i class="fa fa-floppy-o" aria-hidden="true"></i> Save Page
        </button>
      </form>
