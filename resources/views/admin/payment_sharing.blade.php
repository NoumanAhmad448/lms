...
@section('content')
    ...
    <form action="{{ route('a_p_share_payment') }}" method="post">
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <input type="text" class="form-control @error('instructor_share') is-invalid @enderror"
                        id="instructor_share" name="instructor_share" placeholder="Instructor Share"
                        value="@if (isset($setting)) {{ $setting->instructor_share ?? '' }} @endif" />
                    <div>
                        Payment will be sent to Instructor depending upon the percentage you set above.Make sure to set it
                        less than
                        100.
                    </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <input type="text" class="form-control @error('admin_share') is-invalid @enderror" id="admin_share"
                        name="admin_share" placeholder="Admin Payment"
                        value="@if (isset($setting)) {{ $setting->admin_share ?? '' }} @endif" />
                    <div>
                        Payment will be sent to admin depending upon the percentage you set above. Make sure to set it less
                        than
                        100.
                    </div>
                    @error('admin_share')
