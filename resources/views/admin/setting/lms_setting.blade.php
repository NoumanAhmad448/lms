        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="custom-control custom-switch">
                    <input type="checkbox" class="custom-control-input" id="discussion" name="discussion"
                        @if (isset($s) && $s->isDisscussion) {{ __('lms::checked') }} @endif>
                    <label class="custom-control-label" for="discussion"> Enable/Disable </label>
                </div>

                <small class="form-text text-muted"> By enabling discussion, students can ask questions to instructors
                    directory from every lecture page, they will get a form to ask question under every lecture </small>
