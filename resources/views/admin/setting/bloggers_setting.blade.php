...
@section('content')
    ...
    <form action="{{ route('blogger-setting-post') }}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="custom-control custom-switch">
                    <input type="checkbox" class="custom-control-input" id="blog_e_d" name="blog_e_d"
                        @if (isset($s) && $s->isBlog) {{ __('lms::checked') }} @endif>
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-6">
                <div class="custom-control custom-switch">
                    <input type="checkbox" class="custom-control-input" id="faq" name="faq"
                        @if (isset($s) && $s->isFaq) {{ __('lms::checked') }} @endif>
