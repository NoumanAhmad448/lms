                    ...
                    <form action="{{ route('a_c_sorting') }}" method="POST">
                        ...
                        <div class="form-group">
                            <select class="custom-select  mb-3" id="sorting" name="sorting">
                                ...
                                <option value="ai" @if ($order === 'ai') {{ __('selected') }} @endif>
                                    Ascending by ID</option>
                                <option value="di" @if ($order === 'di') {{ __('selected') }} @endif> Desc
                                    by ID </option>
                                <option value="at" @if ($order === 'at') {{ __('selected') }} @endif>
                                    Ascending by title </option>
                                <option value="dt" @if ($order === 'dt') {{ __('selected') }} @endif> Desc
                                    by title </option>
                                <option value="ac" @if ($order === 'ac') {{ __('selected') }} @endif>
                                    Ascending by categories </option>
                                <option value="dc" @if ($order === 'dc') {{ __('selected') }} @endif> Desc
...
@section('page-js')
    ...
    <script>
        $('#draft_courses').addClass('bg-website text-white').removeClass('text-dark font-weight-bold');
    </script>
