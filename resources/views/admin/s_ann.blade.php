    ...
    <x-instructor-notification >        
        ...
        <x-slot name="create_notification">
            <div class="d-flex justify-content-end">
                <a href="{{route('c_info')}}" class="btn btn-lg btn-info">
                    Create Notification 
                </a>
            </div>
        </x-slot>
                ...
                <table class="table">
                    ...
                    @foreach ($instructors as $i)
                        <tr class="con">
                            ...
                            <td> <a href="{{route('show_edit',['i' => $i->id])}}" class="text-info"> Edit </a> </td>
                            <td> <div link="{{route('____delete',['i' => $i->id])}}" class="text-danger cursor_pointer del-not"> Delete </div>  </td>
                        </tr>  
                    @endforeach
...
@section('page-js')
    <script>
        $(function(){            
            $('#s_info').addClass('bg-website text-white').removeClass('text-dark font-weight-bold');
