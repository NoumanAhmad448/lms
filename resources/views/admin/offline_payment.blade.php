...
@section('content')
    ...
    <ul class="nav nav-pills mb-3" id="payment-options" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="bank" data-toggle="pill" href="#bank-form" role="tab" aria-selected="false"> <i
                    class="fa fa-etsy" aria-hidden="true"></i> Bank </a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="other" data-toggle="pill" href="#other-form" role="tab" aria-selected="false">
                <i class="fa fa-money" aria-hidden="true"></i> Other </a>
        </li>
            ...
            <section>
                ...
                <form action="{{ route('a_jazzcash_offline_payment') }}" method="post">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('j_mobile_no') is-invalid @enderror"
                                id="j_mobile_no"
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('j_account_name') is-invalid @enderror"
                                id="j_account_name" name="j_account_name"
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control @error('j_note') is-invalid @enderror" id="j_note" name="j_note"
                                placeholder="Jazzcash Note" rows="10">
@if (isset($offline))
{{ $offline->j_note ?? '' }}
@endif
</textarea>
            ...
            <section>
                ...
                <form action="{{ route('a_easypaisa_offline_payment') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="easypaisa___form"
                                    name="easypaisa___form"
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('e_mobile_number') is-invalid @enderror"
                                id="e_mobile_number"
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('e_account_name') is-invalid @enderror"
                                id="e_account_name" name="e_account_name"
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control @error('e_note') is-invalid @enderror" id="e_note" name="e_note"
                                placeholder="Easypaisa note" rows="10">
@if (isset($offline))
{{ $offline->e_note ?? '' }}
@endif
</textarea>
            ...
            <section>
                ...
                <form action="{{ route('a_bank_offline_payment') }}" method="post">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('b_bank_name') is-invalid @enderror"
                                id="b_bank_name"
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('b_swift_code') is-invalid @enderror"
                                id="b_swift_code"
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('b_account_name') is-invalid @enderror"
                                id="b_account_name" name="b_account_name"
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('b_account_number') is-invalid @enderror"
                                id="b_account_number" name="b_account_number"
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('b_branch_name') is-invalid @enderror"
                                id="b_branch_name" name="b_branch_name"
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('b_branch_address') is-invalid @enderror"
                                id="b_branch_address" name="b_branch_address"
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('b_iban') is-invalid @enderror"
                                id="b_iban" name="b_iban"
            ...
            <section>
                ...
                <form action="{{ route('a_other_offline_payment') }}" method="post">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('o_mobile') is-invalid @enderror"
                                id="o_mobile"
...
@section('page-js')
    ...
    <script>
        $(function() {
            $('#a_offline_payment_gateways').addClass('bg-website text-white').removeClass(
