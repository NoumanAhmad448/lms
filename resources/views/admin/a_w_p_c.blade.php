            ...
            <section>
                ...
                <form action="{{ route('a_withdraw_bank') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('b_min') is-invalid @enderror" id="b_min"
                                value="@if (isset($withdraw)) {{ $withdraw->b_min ?? '' }} @endif" name="b_min"
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control @error('b_note') is-invalid @enderror" id="b_note" name="b_note" rows="10"
                                placeholder="note">
@if (isset($withdraw))
{{ $withdraw->b_note ?? '' }}
@endif
            ...
            <section>
                ...
                <form action="{{ route('a_withdraw_paypal') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('p_min') is-invalid @enderror" id="p_min"
                                value="@if (isset($withdraw)) {{ $withdraw->p_min ?? '' }} @endif" name="p_min"
                                placeholder="minimum amount">
                            @error('p_min')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control @error('p_note') is-invalid @enderror" id="p_note" name="p_note" rows="10"
                                placeholder="note">
@if (isset($withdraw))
{{ $withdraw->p_note ?? '' }}
@endif
            ...
            <section>
                ...
                <form action="{{ route('a_withdraw_jazz') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('j_min') is-invalid @enderror"
                                id="j_min"
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control @error('j_note') is-invalid @enderror" id="j_note" name="j_note" rows="10"
                                placeholder="note">
@if (isset($withdraw))
{{ $withdraw->j_note ?? '' }}
@endif
            ...
            <section>
                ...
                <form action="{{ route('a_withdraw_easypaisa') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('e_min') is-invalid @enderror"
                                id="e_min"
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control @error('e_note') is-invalid @enderror" id="e_note" name="e_note" rows="10"
                                placeholder="note">
@if (isset($withdraw))
{{ $withdraw->e_note ?? '' }}
@endif
