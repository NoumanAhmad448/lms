...
@section('content')
    ...
    <ul class="nav nav-pills mb-3" id="social-option" role="tablist">
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="facebook" data-toggle="pill" href="#facebook-form" role="tab" aria-selected="true"> <i
                    class="fa fa-facebook-official" aria-hidden="true"></i>
                facebook</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="google" data-toggle="pill" href="#google-form" role="tab" aria-selected="false">
            ...
            <section>
                ...
                <form action="{{ route('social_networks_fb') }}" method="post">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control hide @error('fb_app_key') is-invalid @enderror"
                                id="fb_app_key" name="fb_app_key" placeholder="App key"
                                value="@if (isset($social)) {{ $social->f_app_id ?? '' }} @endif" />
                            @error('fb_app_key')
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control hide @error('fb_secret_key') is-invalid @enderror"
                                id="fb_secret_key" name="fb_secret_key" placeholder="Secret key"
                                value="@if (isset($social)) {{ $social->f_security_key ?? '' }} @endif" />
                            @error('fb_secret_key')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <section>
                ...
                <form action="{{ route('social_networks_g') }}" method="post">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control hide @error('g_app_key') is-invalid @enderror"
                                id="g_app_key" name="g_app_key" placeholder="App Key"
                                value="@if (isset($social)) {{ $social->g_app_id ?? '' }} @endif" />
                            @error('g_app_key')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control hide @error('g_secret_key') is-invalid @enderror"
                                id="g_secret_key" name="g_secret_key" placeholder="Secret key"
                                value="@if (isset($social)) {{ $social->g_security_key ?? '' }} @endif" />
                            @error('g_secret_key')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <section>
                ...
                <form action="{{ route('social_networks_li') }}" method="post">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control hide @error('l_app_key') is-invalid @enderror"
                                id="l_app_key" name="l_app_key" placeholder="App key"
                                value="@if (isset($social)) {{ $social->l_app_id ?? '' }} @endif" />
                            @error('l_app_key')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control hide @error('l_secret_key') is-invalid @enderror"
                                id="l_secret_key" name="l_secret_key" placeholder="Secret key"
                                value="@if (isset($social)) {{ $social->l_security_key ?? '' }} @endif" />
                            @error('l_secret_key')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
