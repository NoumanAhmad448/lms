...
@section('content')
    ...
    <div class="d-flex justify-content-end">
        <a href="{{ route('admin_c_p') }}" class="btn btn-lg btn-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
            Create Post
        </a>
    </div>
                ...
                <tbody>
                    @foreach ($posts as $post)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('admin_p_delete', compact('post')) }}" method="post">
                                    @csrf
                                    @method('delete')
                                    <div class="text-danger delete_post cursor_pointer"> <i class="fa fa-trash"
...
@else
    <div class="jumbotron text-center bg-white mt-5">
        <img src="{{ asset('vendor/lms/img/not_found.png') }}" alt="no post found" width="100" height="100"
