        ...
        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
            @include(config('files.forms') . 'col', [
                ...
                config('vars.prop') => [
                    ...
                    config('vars.label') => __('lms::label.flnme'),
            ...
            @include(config('files.forms') . 'col', [
                ...
                config('vars.prop') => [
                    ...
                    config('vars.label') => __('lms::label.age'),
            ...
            @include(config('files.forms') . 'col', [
                ...
                config('vars.prop') => [
                    ...
                    config('vars.label') => __('lms::label.mble_no'),
                    config('vars.include_star') => false,
            ...
            @include(config('files.forms') . 'col', [
                ...
                config('vars.prop') => [
                    ...
                    config('vars.label') => __('lms::label.gender'),
                    config('vars.include_star') => false,
            ...
            @include(config('files.forms') . 'col', [
                ...
                config('vars.prop') => [
                    ...
                    config('vars.label') => __('lms::label.jobs'),
                    config('vars.include_star') => false,
            ...
            @include(config('files.forms') . 'col', [
                ...
                config('vars.prop') => [
                    ...
                    config('vars.label') => __('lms::label.location_desc'),
